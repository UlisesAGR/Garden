    ...
    Column(
        ...
        EmailField(
            ...
            onTextFieldChanged = { email ->
                viewModel.onCreateChanged(email, state.password, state.confirmPassword)
            },
        )
        PasswordField(
            ...
            onTextFieldChanged = { password ->
                viewModel.onCreateChanged(state.email, password, state.confirmPassword)
            },
        ...
        PasswordField(
            ...
            onTextFieldChanged = { confirmPassword ->
                viewModel.onCreateChanged(state.email, state.password, confirmPassword)
            },
            supportingText = stringResource(R.string._6_character_password),
        )
        CheckboxTexButton(
